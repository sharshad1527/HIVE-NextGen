I am ready to implement **Phase 3.1: Cloud Store & UI Virtualization**.

I have read the plan in `plans/phase3/sub_phase_1.md`.
My goal is to implement the conditional catalog fetching, async cloud client, and refactor the UI to use `QListView` with a custom model for virtualization.
