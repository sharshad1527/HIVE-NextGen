I am ready to implement **Phase 3.4: Transitions & Hybrid Captions**.

I have read the plan in `plans/phase3/sub_phase_4.md`.
My goal is to finalize the GPU pipeline with transitions and hybrid caption rendering, and apply final gamma correction.
